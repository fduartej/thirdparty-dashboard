...
To build the final jar and optimize the thirdpartydashboard application for production, run:
...
Then navigate to [http://localhost:6082](http://localhost:6082) in your browser.
